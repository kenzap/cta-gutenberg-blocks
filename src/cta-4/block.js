...
registerBlockType( 'kenzap/cta-44', {
    title: __( 'Kenzap CTA 4', 'kenzap-cta' ),
    icon: 'migrate',
    category: 'layout',
    keywords: [
        __( 'Call', 'kenzap-cta' ),
    ...
    edit: ( props ) => {
        ...
        if(props.attributes.isFirstLoad){ props.setAttributes( { containerPadding: 140, backgroundColor: '#9376df', isFirstLoad: false} ); }

...
registerBlockType( 'kenzap/cta-19', {
    title: __( 'Kenzap Banner 2', 'kenzap-cta' ),
    icon: 'migrate',
    category: 'layout',
    keywords: [
        __( 'Banner', 'kenzap-cta' ),
        __( 'call to action cta 19', 'kenzap-cta' ),
        __( 'countdown', 'kenzap-cta' ),
    ],
    html: true,
    supports: {
        align: [ 'full', 'wide' ],
    ...
    edit: ( props ) => {
        ...
        if(props.attributes.isFirstLoad){
            ...
            props.setAttributes( { textColor:'#ffffff', textColor3:'#750179', textColor4:'#d61010', backgroundColor: '#fff', containerPadding: 140 } );
